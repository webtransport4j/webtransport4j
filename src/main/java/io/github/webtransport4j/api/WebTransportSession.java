...
public class WebTransportSession {
    ...
    public @NonNull Future<WebTransportStream> createUniStream(@NonNull ChannelHandler streamHandler) {
    ...
    private @NonNull Future<WebTransportStream> wrapStreamFuture(@NonNull Future<QuicStreamChannel> streamFuture) {
