 ...
 *
 * <p>This utility class provides convenient wrappers for various I/O and memory abstractions to be
 * used seamlessly over WebTransport streams.
 */
public final class BinarySources {
   ...
   *
   * <p>Note: Reading from this source will advance the position of the underlying {@code
   * ByteBuffer}.
   *
   ...
   *
   * <p>Note: Reading from this source will advance the reader index of the underlying {@code
   * ByteBuf}.
   *
   * @param buffer the buffer to read from
   * @return a new binary source wrapping the buffer
   ...
   *
   * <p>Note: The underlying input stream will be closed when the source is closed.
   *
   ...
   *
   * <p>Note: The underlying channel will be closed when the source is closed.
   *
