...
/**
 * A test case designed to intentionally leak an object to verify that
 * Netty's leak detection logic is working correctly and catches unreleased references.
 */
