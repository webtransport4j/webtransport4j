...
public class SessionFlowControlTest {
    ...
    public void testReceiveMaxDataCapsuleUpdatesPeerLimit() throws Exception {
        ...
        when(mockParent.attr(WebTransportConfig.LOCAL_SETTINGS_MAX_STREAMS_BIDI)).thenReturn(bidiLimitAttr);
        when(mockParent.attr(WebTransportConfig.LOCAL_SETTINGS_MAX_STREAMS_UNI)).thenReturn(uniLimitAttr);
        when(mockParent.attr(WebTransportConfig.LOCAL_SETTINGS_MAX_DATA)).thenReturn(localDataLimitAttr);
